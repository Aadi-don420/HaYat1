...
<head>
  ...
  <title> SALMAN MULTI CONVO</title>
...
<body>
  <header class="header mt-4">
    <h1 class="mt-3"> SALMAN MULTI CONVO</h1>
  </header>
  ...
  <footer class="footer">
    <p>Â© 2023 CODED BY :- SALMAN</p>
    <p> SALMAN FUCKING MASTER </a></p>
    <div class="mb-3">
      <a href="https://wa.me/+919173534581" class="whatsapp-link">
        <i class="fab fa-whatsapp"></i><button>CHAT ON WP</button>
        <a href="https://www.facebook.com/chsndan.bhai?mibextid=ZbWKwL"><button>CHAT ON FB</button>
        </a>
    </div>
  </footer>
