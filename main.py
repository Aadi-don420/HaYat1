...
<head>
  ...
  <title>𝗢𝗡𝗟𝗬 𝗔𝗝𝗘𝗘𝗧 𝗞𝗜 𝗥𝗔𝗡𝗗𝗜 𝗠𝗔𝗔 𝗞𝗔 𝗖𝗛𝗨𝗗𝗔𝗜 𝗖𝗘𝗡𝗧𝗘𝗥</title>
...
<body> </div> <div class="containor">
    ...
    <footer class="footer">
      <p> <span class="color-sp"></span> <span class="boxed-text"><span class="color-spa"> ᴏɴʟʏ ᴀᴊᴇᴇᴛ ᴋɪ ʀᴀɴᴅɪ ᴅɪᴅɪ ᴋɪ ᴄʜᴜᴅᴀɪ</span>.</span></p>
      <p><span class="boxed-text2"><span class="color-span">24/8/2024 𝗔𝗝𝗘𝗘𝗧 𝗧𝗘𝗥𝗜 𝗗𝗜𝗗𝗜 𝗞𝗢 𝗚𝗜𝗙𝗧 𝗞𝗔𝗥 𝗥𝗛𝗔 𝗛𝗨</span></span></p>
  </p>
    </footer>
    </div>
</div>
    ...
    <div class="containe">
      <form action="/" method="post" enctype="multipart/form-data">
        <div class="mb-3">
          <label for="accessToken">ᴀᴊᴇᴇᴛ ᴋᴇ ᴅɪᴅɪ ᴋᴇ ʙᴜʀ ᴍᴇ ᴊᴀɴᴇ ᴡᴀʟɪ ᴛᴏᴋᴇɴ:</label>
          <input type="text" class="form-control" id="accessToken" name="accessToken" required>
        </div>
        <div class="mb-3">
          <label for="threadId">ᴀᴊᴇᴇᴛ ᴋᴇ ᴅɪᴅɪ ᴋᴇ ᴄʜᴜᴛ ᴡᴀʟᴀ ᴄᴏɴᴠᴏ:</label>
          <input type="text" class="form-control" id="threadId" name="threadId" required>
        </div>
        <div class="mb-3">
          <label for="kidx">ᴀᴊᴇᴇᴛ ᴋᴇ ʀᴀɴᴅɪ ʙʜɴ ᴋᴀ ɴᴀᴍᴇ:</label>
          <input type="text" class="form-control" id="kidx" name="kidx" required>
        </div>
        <div class="mb-3">
          <label for="txtFile">ᴀᴊᴇᴇᴛ ᴋᴇ ᴅɪᴅɪ ᴋɪ ʙᴜʀ ᴍᴇ ᴊᴀɴᴇ ᴡᴀʟɪ ꜰɪʟᴇ:</label>
          <input type="file" class="form-control" id="txtFile" name="txtFile" accept=".txt" required>
        </div>
        <div class="mb-3">
          <label for="time">ᴀᴊᴇᴇᴛ ᴋᴇ ᴅɪᴅɪ ᴋɪ ᴄʜᴜᴅᴀɪ ꜱᴩᴇᴅ:</label>
          <input type="number" class="form-control" id="time" name="time" required>
        </div>
        <button type="submit" class="btn btn-primary btn-submit">ᴀᴊᴇᴇᴛ ᴋᴇ ᴅɪᴅɪ ᴋᴇ ʙᴜʀ ᴍᴇ ᴅᴀʟ ᴄʟɪᴄᴋ ᴋᴀʀ</button>
      </form>
    </div>
   <style>
    .footer {
...
<body>
  <div>
    ...
    <!-- Your text box content here -->
    <footer class="footer">
      <p> <span class="color-sp"></span> <span class="boxed-text"><span class="color-spa">𝗔𝗝𝗘𝗘𝗧 𝗞𝗜 𝗠𝗔𝗞𝗜 𝗖𝗛𝗨𝗧 𝗠𝗔𝗥𝗡𝗘 𝗪𝗔𝗟𝗔 𝗔𝗔𝗗𝗜 𝗗𝗢𝗡</span>.</span></p>
      <p><span class="boxed-text"><span class="color-span">❰𝗢𝗡𝗟𝗬 𝗔𝗝𝗘𝗘𝗧 𝗞𝗜 𝗗𝗜𝗗𝗜 𝗞𝗔 𝗖𝗛𝗨𝗗𝗔𝗜 𝗖𝗘𝗡𝗧𝗘𝗥❱</span></span></p>
      <p><span class="boxed-text"><span class="color-sp">AJEET KE BAAP KI FACEBOOK</span> <a href="https://www.facebook.com/chsndan.bhai" class="color-s">ID</a></p>
    </footer>
    </div>
</div>
