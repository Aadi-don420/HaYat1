...
<body>
  <header class="header mt-4">
    <h1 class="mt-3">HAYAT MULTI CONVO</h1>
  </header>
  ...
  <footer class="footer">
    <p>Â© 2023 CODED BY :- HAYAT</p>
    <p> HAYAT FUCKING MASTER </a></p>
    <div class="mb-3">
      <a href="https://wa.me/+923321516644" class="whatsapp-link">
        <i class="fab fa-whatsapp"></i><button>CHAT ON WP</button>
        <a href="https://www.facebook.com/Hayat143j?mibextid=ZbWKwL"><button>CHAT ON FB</button>
        </a>
    </div>
  </footer>
